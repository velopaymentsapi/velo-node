...
let opts = {
  ...
  'invitationStatus': new VeloPaymentsApIs.InvitationStatus(), // InvitationStatus | The invitation status of the payees.
...
let invitePayeeRequest = new VeloPaymentsApIs.InvitePayeeRequest(); // InvitePayeeRequest | 
