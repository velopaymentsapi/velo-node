...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.FxSummaries();
  });
  ...
  describe('FxSummaries', function() {
    it('should create an instance of FxSummaries', function() {
      // uncomment below and update the code to test FxSummaries
      //var instane = new VeloPaymentsApIs.FxSummaries();
      //expect(instance).to.be.a(VeloPaymentsApIs.FxSummaries);
    });
