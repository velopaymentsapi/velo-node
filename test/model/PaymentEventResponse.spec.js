...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PaymentEventResponse();
  });
  ...
  describe('PaymentEventResponse', function() {
    it('should create an instance of PaymentEventResponse', function() {
      ...
      //var instane = new VeloPayments.PaymentEventResponse();
      //expect(instance).to.be.a(VeloPayments.PaymentEventResponse);
    });
    ...
    it('should have the property eventId (base name: "eventId")', function() {
      ...
      //var instance = new VeloPayments.PaymentEventResponse();
