...
(function(root, factory) {
  ...
  describe('PaymentEventResponse', function() {
    it('should create an instance of PaymentEventResponse', function() {
      ...
      //var instane = new VeloPaymentsApIs.PaymentEventResponse();
    ...
    it('should have the property principle (base name: "principle")', function() {
      // uncomment below and update the code to test the property principle
      //var instane = new VeloPaymentsApIs.PaymentEventResponse();
      //expect(instance).to.be();
    });
