...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PaymentEventResponseV3();
  });
  ...
  describe('PaymentEventResponseV3', function() {
    it('should create an instance of PaymentEventResponseV3', function() {
      // uncomment below and update the code to test PaymentEventResponseV3
      //var instane = new VeloPayments.PaymentEventResponseV3();
      //expect(instance).to.be.a(VeloPayments.PaymentEventResponseV3);
    });
    ...
    it('should have the property eventId (base name: "eventId")', function() {
      ...
      //var instance = new VeloPayments.PaymentEventResponseV3();
