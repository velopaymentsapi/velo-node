...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PagedPayeeInvitationStatusResponsePage();
  });
  ...
  describe('PagedPayeeInvitationStatusResponsePage', function() {
    it('should create an instance of PagedPayeeInvitationStatusResponsePage', function() {
      // uncomment below and update the code to test PagedPayeeInvitationStatusResponsePage
      //var instane = new VeloPayments.PagedPayeeInvitationStatusResponsePage();
      //expect(instance).to.be.a(VeloPayments.PagedPayeeInvitationStatusResponsePage);
    });
    ...
    it('should have the property numberOfElements (base name: "numberOfElements")', function() {
      ...
      //var instance = new VeloPayments.PagedPayeeInvitationStatusResponsePage();
