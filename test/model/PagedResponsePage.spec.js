...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.PagedResponsePage();
  });
  ...
  describe('PagedResponsePage', function() {
    it('should create an instance of PagedResponsePage', function() {
      // uncomment below and update the code to test PagedResponsePage
      //var instane = new VeloPaymentsApIs.PagedResponsePage();
      //expect(instance).to.be.a(VeloPaymentsApIs.PagedResponsePage);
    });
