...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PayableStatusChanged();
  });
  ...
  describe('PayableStatusChanged', function() {
    it('should create an instance of PayableStatusChanged', function() {
      // uncomment below and update the code to test PayableStatusChanged
      //var instane = new VeloPayments.PayableStatusChanged();
      //expect(instance).to.be.a(VeloPayments.PayableStatusChanged);
    });
    ...
    it('should have the property sourceType (base name: "sourceType")', function() {
      ...
      //var instance = new VeloPayments.PayableStatusChanged();
