...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.SupportedCountry2();
  });
  ...
  describe('SupportedCountry2', function() {
    it('should create an instance of SupportedCountry2', function() {
      // uncomment below and update the code to test SupportedCountry2
      //var instane = new VeloPayments.SupportedCountry2();
      //expect(instance).to.be.a(VeloPayments.SupportedCountry2);
    });
