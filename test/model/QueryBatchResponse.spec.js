...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.QueryBatchResponse();
  });
  ...
  describe('QueryBatchResponse', function() {
    it('should create an instance of QueryBatchResponse', function() {
      // uncomment below and update the code to test QueryBatchResponse
      //var instane = new VeloPayments.QueryBatchResponse();
      //expect(instance).to.be.a(VeloPayments.QueryBatchResponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new VeloPayments.QueryBatchResponse();
