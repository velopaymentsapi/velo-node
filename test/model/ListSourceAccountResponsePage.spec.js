...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.ListSourceAccountResponsePage();
  });
  ...
  describe('ListSourceAccountResponsePage', function() {
    it('should create an instance of ListSourceAccountResponsePage', function() {
      // uncomment below and update the code to test ListSourceAccountResponsePage
      //var instane = new VeloPayments.ListSourceAccountResponsePage();
      //expect(instance).to.be.a(VeloPayments.ListSourceAccountResponsePage);
    });
    ...
    it('should have the property numberOfElements (base name: "numberOfElements")', function() {
      ...
      //var instance = new VeloPayments.ListSourceAccountResponsePage();
