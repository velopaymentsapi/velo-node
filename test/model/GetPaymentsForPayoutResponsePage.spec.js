...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.GetPaymentsForPayoutResponsePage();
  });
  ...
  describe('GetPaymentsForPayoutResponsePage', function() {
    it('should create an instance of GetPaymentsForPayoutResponsePage', function() {
      // uncomment below and update the code to test GetPaymentsForPayoutResponsePage
      //var instane = new VeloPaymentsApIs.GetPaymentsForPayoutResponsePage();
      //expect(instance).to.be.a(VeloPaymentsApIs.GetPaymentsForPayoutResponsePage);
    });
