...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PayeePaymentChannel2();
  });
  ...
  describe('PayeePaymentChannel2', function() {
    it('should create an instance of PayeePaymentChannel2', function() {
      // uncomment below and update the code to test PayeePaymentChannel2
      //var instane = new VeloPayments.PayeePaymentChannel2();
      //expect(instance).to.be.a(VeloPayments.PayeePaymentChannel2);
    });
