...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.AuthResponse();
  });
  ...
  describe('AuthResponse', function() {
    it('should create an instance of AuthResponse', function() {
      ...
      //var instane = new VeloPayments.AuthResponse();
      //expect(instance).to.be.a(VeloPayments.AuthResponse);
    });
    ...
    it('should have the property accessToken (base name: "access_token")', function() {
      ...
      //var instance = new VeloPayments.AuthResponse();
