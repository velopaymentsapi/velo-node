...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.SchedulePayoutRequest();
  });
  ...
  describe('SchedulePayoutRequest', function() {
    it('should create an instance of SchedulePayoutRequest', function() {
      // uncomment below and update the code to test SchedulePayoutRequest
      //var instance = new VeloPayments.SchedulePayoutRequest();
      //expect(instance).to.be.a(VeloPayments.SchedulePayoutRequest);
    });
