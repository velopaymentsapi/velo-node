...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PaymentChannelCountry();
  });
  ...
  describe('PaymentChannelCountry', function() {
    it('should create an instance of PaymentChannelCountry', function() {
      // uncomment below and update the code to test PaymentChannelCountry
      //var instane = new VeloPayments.PaymentChannelCountry();
      //expect(instance).to.be.a(VeloPayments.PaymentChannelCountry);
    });
    ...
    it('should have the property isoCountryCode (base name: "isoCountryCode")', function() {
      ...
      //var instance = new VeloPayments.PaymentChannelCountry();
