...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.QueryBatchResponse2();
  });
  ...
  describe('QueryBatchResponse2', function() {
    it('should create an instance of QueryBatchResponse2', function() {
      // uncomment below and update the code to test QueryBatchResponse2
      //var instane = new VeloPayments.QueryBatchResponse2();
      //expect(instance).to.be.a(VeloPayments.QueryBatchResponse2);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new VeloPayments.QueryBatchResponse2();
