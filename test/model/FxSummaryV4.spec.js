...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.FxSummaryV4();
  });
  ...
  describe('FxSummaryV4', function() {
    it('should create an instance of FxSummaryV4', function() {
      // uncomment below and update the code to test FxSummaryV4
      //var instane = new VeloPaymentsApIs.FxSummaryV4();
      //expect(instance).to.be.a(VeloPaymentsApIs.FxSummaryV4);
    });
