...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PagedPayeeResponsePage();
  });
  ...
  describe('PagedPayeeResponsePage', function() {
    it('should create an instance of PagedPayeeResponsePage', function() {
      // uncomment below and update the code to test PagedPayeeResponsePage
      //var instane = new VeloPayments.PagedPayeeResponsePage();
      //expect(instance).to.be.a(VeloPayments.PagedPayeeResponsePage);
    });
    ...
    it('should have the property numberOfElements (base name: "numberOfElements")', function() {
      ...
      //var instance = new VeloPayments.PagedPayeeResponsePage();
