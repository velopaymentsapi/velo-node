...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.ListPaymentsResponsePage();
  });
  ...
  describe('ListPaymentsResponsePage', function() {
    it('should create an instance of ListPaymentsResponsePage', function() {
      // uncomment below and update the code to test ListPaymentsResponsePage
      //var instane = new VeloPaymentsApIs.ListPaymentsResponsePage();
      //expect(instance).to.be.a(VeloPaymentsApIs.ListPaymentsResponsePage);
    });
