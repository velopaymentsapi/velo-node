...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.QuoteFxSummary();
  });
  ...
  describe('QuoteFxSummary', function() {
    it('should create an instance of QuoteFxSummary', function() {
      // uncomment below and update the code to test QuoteFxSummary
      //var instane = new VeloPaymentsApIs.QuoteFxSummary();
      //expect(instance).to.be.a(VeloPaymentsApIs.QuoteFxSummary);
    });
