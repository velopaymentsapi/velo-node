...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.CreatePaymentChannel();
  });
  ...
  describe('CreatePaymentChannel', function() {
    it('should create an instance of CreatePaymentChannel', function() {
      // uncomment below and update the code to test CreatePaymentChannel
      //var instane = new VeloPayments.CreatePaymentChannel();
      //expect(instance).to.be.a(VeloPayments.CreatePaymentChannel);
    });
    ...
    it('should have the property paymentChannelName (base name: "paymentChannelName")', function() {
      ...
      //var instance = new VeloPayments.CreatePaymentChannel();
