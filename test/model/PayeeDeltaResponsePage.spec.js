...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PayeeDeltaResponsePage();
  });
  ...
  describe('PayeeDeltaResponsePage', function() {
    it('should create an instance of PayeeDeltaResponsePage', function() {
      // uncomment below and update the code to test PayeeDeltaResponsePage
      //var instane = new VeloPayments.PayeeDeltaResponsePage();
      //expect(instance).to.be.a(VeloPayments.PayeeDeltaResponsePage);
    });
    ...
    it('should have the property numberOfElements (base name: "numberOfElements")', function() {
      ...
      //var instance = new VeloPayments.PayeeDeltaResponsePage();
