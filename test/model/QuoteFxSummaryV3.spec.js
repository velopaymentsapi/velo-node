...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.QuoteFxSummaryV3();
  });
  ...
  describe('QuoteFxSummaryV3', function() {
    it('should create an instance of QuoteFxSummaryV3', function() {
      ...
      //var instane = new VeloPayments.QuoteFxSummaryV3();
      //expect(instance).to.be.a(VeloPayments.QuoteFxSummaryV3);
    });

    it('should have the property rate (base name: "rate")', function() {
      // uncomment below and update the code to test the property rate
      //var instance = new VeloPayments.QuoteFxSummaryV3();
