...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.PaymentEventResponseV4();
  });
  ...
  describe('PaymentEventResponseV4', function() {
    it('should create an instance of PaymentEventResponseV4', function() {
      // uncomment below and update the code to test PaymentEventResponseV4
      //var instane = new VeloPaymentsApIs.PaymentEventResponseV4();
      //expect(instance).to.be.a(VeloPaymentsApIs.PaymentEventResponseV4);
    });
