...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.AccessTokenResponse();
  });
  ...
  describe('AccessTokenResponse', function() {
    it('should create an instance of AccessTokenResponse', function() {
      ...
      //var instane = new VeloPayments.AccessTokenResponse();
      //expect(instance).to.be.a(VeloPayments.AccessTokenResponse);
    });
    ...
    it('should have the property accessToken (base name: "access_token")', function() {
      ...
      //var instance = new VeloPayments.AccessTokenResponse();
