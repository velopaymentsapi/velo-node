...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.UserInfo();
  });
  ...
  describe('UserInfo', function() {
    it('should create an instance of UserInfo', function() {
      ...
      //var instane = new VeloPayments.UserInfo();
      //expect(instance).to.be.a(VeloPayments.UserInfo);
    });

    it('should have the property userId (base name: "user_id")', function() {
      // uncomment below and update the code to test the property userId
      //var instance = new VeloPayments.UserInfo();
