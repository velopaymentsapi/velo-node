...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.CreatePaymentChannel2();
  });
  ...
  describe('CreatePaymentChannel2', function() {
    it('should create an instance of CreatePaymentChannel2', function() {
      // uncomment below and update the code to test CreatePaymentChannel2
      //var instane = new VeloPayments.CreatePaymentChannel2();
      //expect(instance).to.be.a(VeloPayments.CreatePaymentChannel2);
    });
    ...
    it('should have the property paymentChannelName (base name: "paymentChannelName")', function() {
      ...
      //var instance = new VeloPayments.CreatePaymentChannel2();
