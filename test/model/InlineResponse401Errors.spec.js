...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.InlineResponse401Errors();
  });
  ...
  describe('InlineResponse401Errors', function() {
    it('should create an instance of InlineResponse401Errors', function() {
      // uncomment below and update the code to test InlineResponse401Errors
      //var instane = new VeloPayments.InlineResponse401Errors();
      //expect(instance).to.be.a(VeloPayments.InlineResponse401Errors);
    });
