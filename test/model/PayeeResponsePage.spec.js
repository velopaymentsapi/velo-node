...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPaymentsApIs.PayeeResponsePage();
  });
  ...
  describe('PayeeResponsePage', function() {
    it('should create an instance of PayeeResponsePage', function() {
      // uncomment below and update the code to test PayeeResponsePage
      //var instane = new VeloPaymentsApIs.PayeeResponsePage();
      //expect(instance).to.be.a(VeloPaymentsApIs.PayeeResponsePage);
    });
