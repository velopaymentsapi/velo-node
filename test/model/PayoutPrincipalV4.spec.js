...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PayoutPrincipalV4();
  });
  ...
  describe('PayoutPrincipalV4', function() {
    it('should create an instance of PayoutPrincipalV4', function() {
      // uncomment below and update the code to test PayoutPrincipalV4
      //var instane = new VeloPayments.PayoutPrincipalV4();
      //expect(instance).to.be.a(VeloPayments.PayoutPrincipalV4);
    });
