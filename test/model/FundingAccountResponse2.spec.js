...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.FundingAccountResponse2();
  });
  ...
  describe('FundingAccountResponse2', function() {
    it('should create an instance of FundingAccountResponse2', function() {
      // uncomment below and update the code to test FundingAccountResponse2
      //var instane = new VeloPayments.FundingAccountResponse2();
      //expect(instance).to.be.a(VeloPayments.FundingAccountResponse2);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new VeloPayments.FundingAccountResponse2();
