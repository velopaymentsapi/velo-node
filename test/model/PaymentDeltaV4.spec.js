...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.PaymentDeltaV4();
  });
  ...
  describe('PaymentDeltaV4', function() {
    it('should create an instance of PaymentDeltaV4', function() {
      // uncomment below and update the code to test PaymentDeltaV4
      //var instane = new VeloPayments.PaymentDeltaV4();
      //expect(instance).to.be.a(VeloPayments.PaymentDeltaV4);
    });
