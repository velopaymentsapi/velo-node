...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.InlineResponse409Errors();
  });
  ...
  describe('InlineResponse409Errors', function() {
    it('should create an instance of InlineResponse409Errors', function() {
      // uncomment below and update the code to test InlineResponse409Errors
      //var instane = new VeloPayments.InlineResponse409Errors();
      //expect(instance).to.be.a(VeloPayments.InlineResponse409Errors);
    });
