...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.FxSummaryV3();
  });
  ...
  describe('FxSummaryV3', function() {
    it('should create an instance of FxSummaryV3', function() {
      ...
      //var instane = new VeloPayments.FxSummaryV3();
      //expect(instance).to.be.a(VeloPayments.FxSummaryV3);
    });
    ...
    it('should have the property quoteId (base name: "quoteId")', function() {
      ...
      //var instance = new VeloPayments.FxSummaryV3();
