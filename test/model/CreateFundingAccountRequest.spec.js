...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VeloPayments.CreateFundingAccountRequest();
  });
  ...
  describe('CreateFundingAccountRequest', function() {
    it('should create an instance of CreateFundingAccountRequest', function() {
      // uncomment below and update the code to test CreateFundingAccountRequest
      //var instane = new VeloPayments.CreateFundingAccountRequest();
      //expect(instance).to.be.a(VeloPayments.CreateFundingAccountRequest);
    });
