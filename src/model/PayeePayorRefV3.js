...
class PayeePayorRefV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payableIssues')) {
                obj['payableIssues'] = ApiClient.convertToType(data['payableIssues'], [PayableIssueV3]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PayeePayorRefV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeePayorRefV3</code>.
     */
    static validateJSON(data) {
        ...
        if (data['payableIssues']) { // data not null
            ...
            for (const item of data['payableIssues']) {
                PayableIssueV3.validateJSON(item);
            };
        }
 ...
 * @member {Array.<module:model/PayableIssueV3>} payableIssues
 */
...
export default PayeePayorRefV3;
