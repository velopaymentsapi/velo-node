...
import InvitationStatusV3 from './InvitationStatusV3';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('invitationStatus')) {
                obj['invitationStatus'] = InvitationStatusV3.constructFromObject(data['invitationStatus']);
            }
...
/**
 * @member {module:model/InvitationStatusV3} invitationStatus
 */
