...
import InvitationStatus2 from './InvitationStatus2';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('invitationStatus')) {
                obj['invitationStatus'] = InvitationStatus2.constructFromObject(data['invitationStatus']);
            }
            ...
            if (data.hasOwnProperty('payableIssues')) {
                obj['payableIssues'] = ApiClient.convertToType(data['payableIssues'], [PayableIssue]);
            }
        }
        return obj;
    }
