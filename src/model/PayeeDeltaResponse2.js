...
import PayeeDeltaResponse2Links from './PayeeDeltaResponse2Links';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [PayeeDeltaResponse2Links]);
            }
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PayeeDelta2]);
            }
        }
        return obj;
    }
...
export default PayeeDeltaResponse2;
