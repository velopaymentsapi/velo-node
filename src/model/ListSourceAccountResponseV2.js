...
import ListSourceAccountResponseV2Page from './ListSourceAccountResponseV2Page';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('page')) {
                obj['page'] = ListSourceAccountResponseV2Page.constructFromObject(data['page']);
            }
...
/**
 * @member {module:model/ListSourceAccountResponseV2Page} page
 */
