...
import FundingEvent2 from './FundingEvent2';
...
class FundingAudit {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fundingAccountName')) {
                obj['fundingAccountName'] = ApiClient.convertToType(data['fundingAccountName'], 'String');
            }
            if (data.hasOwnProperty('fundingType')) {
                obj['fundingType'] = ApiClient.convertToType(data['fundingType'], 'String');
            }
            if (data.hasOwnProperty('events')) {
                obj['events'] = ApiClient.convertToType(data['events'], [FundingEvent2]);
            }
            if (data.hasOwnProperty('topupType')) {
                obj['topupType'] = ApiClient.convertToType(data['topupType'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>FundingAudit</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundingAudit</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['fundingAccountName'] && !(typeof data['fundingAccountName'] === 'string' || data['fundingAccountName'] instanceof String)) {
            throw new Error("Expected the field `fundingAccountName` to be a primitive type in the JSON string but got " + data['fundingAccountName']);
        }
        // ensure the json data is a string
        ...
        if (data['events']) { // data not null
            ...
            for (const item of data['events']) {
                FundingEvent2.validateJSON(item);
            };
        }
        // ensure the json data is a string
        if (data['topupType'] && !(typeof data['topupType'] === 'string' || data['topupType'] instanceof String)) {
            throw new Error("Expected the field `topupType` to be a primitive type in the JSON string but got " + data['topupType']);
        }
        // ensure the json data is a string
 ...
 */
FundingAudit.prototype['payorId'] = undefined;
