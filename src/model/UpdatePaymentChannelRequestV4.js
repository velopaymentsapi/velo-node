...
/**
 * The UpdatePaymentChannelRequestV4 model module.
 * @module model/UpdatePaymentChannelRequestV4
 * @version 2.37.150-beta.1
 */
class UpdatePaymentChannelRequestV4 {
    /**
     * Constructs a new <code>UpdatePaymentChannelRequestV4</code>.
     * @alias module:model/UpdatePaymentChannelRequestV4
     */
    constructor() { 
        
        UpdatePaymentChannelRequestV4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UpdatePaymentChannelRequestV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UpdatePaymentChannelRequestV4} obj Optional instance to populate.
     * @return {module:model/UpdatePaymentChannelRequestV4} The populated <code>UpdatePaymentChannelRequestV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdatePaymentChannelRequestV4();
    ...
    /**
     * Validates the JSON data with respect to <code>UpdatePaymentChannelRequestV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UpdatePaymentChannelRequestV4</code>.
     */
 ...
 */
UpdatePaymentChannelRequestV4.prototype['routingNumber'] = undefined;

/**
 * @member {String} accountNumber
 */
UpdatePaymentChannelRequestV4.prototype['accountNumber'] = undefined;

/**
 * Must match the regular expression ```^[A-Za-z0-9]+$```.
 * @member {String} iban
 */
UpdatePaymentChannelRequestV4.prototype['iban'] = undefined;

/**
 * @member {String} paymentChannelName
 */
UpdatePaymentChannelRequestV4.prototype['paymentChannelName'] = undefined;
 ...
 */
UpdatePaymentChannelRequestV4.prototype['countryCode'] = undefined;

/**
 * @member {String} accountName
 */
UpdatePaymentChannelRequestV4.prototype['accountName'] = undefined;

/**
 * Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
 * @member {String} currency
 */
UpdatePaymentChannelRequestV4.prototype['currency'] = undefined;
...
export default UpdatePaymentChannelRequestV4;
