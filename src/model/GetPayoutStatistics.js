...
class GetPayoutStatistics {
     ...
     */
    constructor(thisMonthPayoutsCount, thisMonthFailedPaymentsCount) { 
     ...
     */
    static initialize(obj, thisMonthPayoutsCount, thisMonthFailedPaymentsCount) { 
...
GetPayoutStatistics.RequiredProperties = ["thisMonthPayoutsCount", "thisMonthFailedPaymentsCount"];
