...
class PayeeEvent {
    ...
    constructor(sourceType, eventId, createdAt, payeeId) { 
        SourceEvent.initialize(this, sourceType, eventId, createdAt);PayeeEventAllOf.initialize(this, payeeId);
...
PayeeEvent.RequiredProperties = ["sourceType", "eventId", "createdAt", "payeeId"];
