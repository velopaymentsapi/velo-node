...
class PayorEmailOptOutRequest {
     ...
     */
    constructor(reminderEmailsOptOut) { 
     ...
     */
    static initialize(obj, reminderEmailsOptOut) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PayorEmailOptOutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorEmailOptOutRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorEmailOptOutRequest.RequiredProperties) {
            if (!data[property]) {
...
PayorEmailOptOutRequest.RequiredProperties = ["reminderEmailsOptOut"];
...
export default PayorEmailOptOutRequest;
