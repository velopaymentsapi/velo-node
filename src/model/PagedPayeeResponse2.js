    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = PagedPayeeResponse2Summary.constructFromObject(data['summary']);
            }
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PayeeResponse2]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/PayeeResponse2>} content
 */
...
export default PagedPayeeResponse2;
