...
class PayorCreateApiKeyRequest {
     ...
     * @param roles {Array.<module:model/PayorCreateApiKeyRequest.RolesEnum>} <p>A role to assign to the key.</p> <p>If you want your API key to have write access then assign the role velo.payor.admin</p> <p>A later version will change this property from a list to string</p> 
     */
    ...
    /**
     * Validates the JSON data with respect to <code>PayorCreateApiKeyRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorCreateApiKeyRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorCreateApiKeyRequest.RequiredProperties) {
            if (!data[property]) {
...
PayorCreateApiKeyRequest.RequiredProperties = ["name", "roles"];
...
export default PayorCreateApiKeyRequest;
