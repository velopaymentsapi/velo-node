...
import FxSummaryV4 from './FxSummaryV4';
import PayoutStatusV4 from './PayoutStatusV4';
import PayoutTypeV4 from './PayoutTypeV4';
import SourceAccountSummaryV4 from './SourceAccountSummaryV4';
...
class PayoutSummaryAuditV4 {
     ...
     */
    constructor(payoutId, status, submittedDateTime, payoutType) { 
        
        PayoutSummaryAuditV4.initialize(this, payoutId, status, submittedDateTime, payoutType);
    }
     ...
     */
    static initialize(obj, payoutId, status, submittedDateTime, payoutType) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('status')) {
                obj['status'] = PayoutStatusV4.constructFromObject(data['status']);
            }
            ...
            if (data.hasOwnProperty('sourceAccountSummary')) {
                obj['sourceAccountSummary'] = ApiClient.convertToType(data['sourceAccountSummary'], [SourceAccountSummaryV4]);
            }
            if (data.hasOwnProperty('fxSummaries')) {
                obj['fxSummaries'] = ApiClient.convertToType(data['fxSummaries'], [FxSummaryV4]);
            }
...
export default PayoutSummaryAuditV4;
