...
class QuoteFxSummaryV3 {
     ...
     */
    constructor(rate, creationTime, quoteId, totalSourceAmount, totalPaymentAmount, sourceCurrency, paymentCurrency, fundingStatus, status) { 
     ...
     */
    static initialize(obj, rate, creationTime, quoteId, totalSourceAmount, totalPaymentAmount, sourceCurrency, paymentCurrency, fundingStatus, status) { 
        obj['rate'] = rate;
...
QuoteFxSummaryV3.RequiredProperties = ["rate", "creationTime", "quoteId", "totalSourceAmount", "totalPaymentAmount", "sourceCurrency", "paymentCurrency", "fundingStatus", "status"];
