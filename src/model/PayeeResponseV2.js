    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payorRefs')) {
                obj['payorRefs'] = ApiClient.convertToType(data['payorRefs'], [PayeePayorRefV2]);
            }
            ...
            if (data.hasOwnProperty('ofacStatus')) {
                obj['ofacStatus'] = OfacStatus2.constructFromObject(data['ofacStatus']);
            }
            ...
            if (data.hasOwnProperty('ofacOverride')) {
                obj['ofacOverride'] = ApiClient.convertToType(data['ofacOverride'], 'Boolean');
            }
            if (data.hasOwnProperty('ofacOverrideReason')) {
                obj['ofacOverrideReason'] = ApiClient.convertToType(data['ofacOverrideReason'], 'String');
            }
            if (data.hasOwnProperty('ofacOverrideTimestamp')) {
                obj['ofacOverrideTimestamp'] = ApiClient.convertToType(data['ofacOverrideTimestamp'], 'String');
            }
...
export default PayeeResponseV2;
