...
import PayeeDeltaResponseLinks from './PayeeDeltaResponseLinks';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('links')) {
                obj['links'] = ApiClient.convertToType(data['links'], [PayeeDeltaResponseLinks]);
            }
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PayeeDelta]);
            }
        }
        return obj;
    }
...
export default PayeeDeltaResponse;
