...
class PayoutPayorIds {
     ...
     */
    constructor(submittingPayorId, payoutFromPayorId, payoutToPayorId) { 
     ...
     */
    static initialize(obj, submittingPayorId, payoutFromPayorId, payoutToPayorId) { 
...
PayoutPayorIds.RequiredProperties = ["submittingPayorId", "payoutFromPayorId", "payoutToPayorId"];
