...
class PayorLinksResponseLinks {
     ...
     */
    constructor(linkId, fromPayorId, linkType, toPayorId) { 
     ...
     */
    static initialize(obj, linkId, fromPayorId, linkType, toPayorId) { 
        obj['linkId'] = linkId;
...
PayorLinksResponseLinks.RequiredProperties = ["linkId", "fromPayorId", "linkType", "toPayorId"];
