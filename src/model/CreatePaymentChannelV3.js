...
class CreatePaymentChannelV3 {
     ...
     */
    constructor(countryCode, currency, accountName) { 
        
        CreatePaymentChannelV3.initialize(this, countryCode, currency, accountName);
    }
     ...
     */
    static initialize(obj, countryCode, currency, accountName) { 
...
CreatePaymentChannelV3.RequiredProperties = ["countryCode", "currency", "accountName"];
