...
/**
 * The PaymentChannelSummaryV4 model module.
 * @module model/PaymentChannelSummaryV4
 * @version 2.37.150-beta.1
 */
class PaymentChannelSummaryV4 {
    /**
     * Constructs a new <code>PaymentChannelSummaryV4</code>.
     * @alias module:model/PaymentChannelSummaryV4
     * @param paymentChannelId {String} 
     * @param name {String} The payment channel name
     ...
     * @param enabled {Boolean} Usually true. False if an associated payment is returned
     */
    constructor(paymentChannelId, name, countryCode, currency, enabled) { 
        
        PaymentChannelSummaryV4.initialize(this, paymentChannelId, name, countryCode, currency, enabled);
    }
     ...
     */
    static initialize(obj, paymentChannelId, name, countryCode, currency, enabled) { 
        obj['paymentChannelId'] = paymentChannelId;
        obj['name'] = name;
    ...
    /**
     * Constructs a <code>PaymentChannelSummaryV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PaymentChannelSummaryV4} obj Optional instance to populate.
     * @return {module:model/PaymentChannelSummaryV4} The populated <code>PaymentChannelSummaryV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentChannelSummaryV4();
    ...
    /**
     * Validates the JSON data with respect to <code>PaymentChannelSummaryV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PaymentChannelSummaryV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PaymentChannelSummaryV4.RequiredProperties) {
            if (!data[property]) {
...
PaymentChannelSummaryV4.RequiredProperties = ["paymentChannelId", "name", "countryCode", "currency", "enabled"];

/**
 * @member {String} paymentChannelId
 */
PaymentChannelSummaryV4.prototype['paymentChannelId'] = undefined;

/**
 * The payment channel name
 * @member {String} name
 */
PaymentChannelSummaryV4.prototype['name'] = undefined;
 ...
 */
PaymentChannelSummaryV4.prototype['countryCode'] = undefined;

/**
 * Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
 * @member {String} currency
 */
PaymentChannelSummaryV4.prototype['currency'] = undefined;

/**
 * The last 4 digits of the account number or IBAN
 * @member {String} last4Digits
 */
PaymentChannelSummaryV4.prototype['last4Digits'] = undefined;

/**
 * Usually true. False if an associated payment is returned
 * @member {Boolean} enabled
 */
PaymentChannelSummaryV4.prototype['enabled'] = undefined;

/**
 * Indicates why the payment channel was disabled
 * @member {String} disabledReason
 */
PaymentChannelSummaryV4.prototype['disabledReason'] = undefined;

/**
 * @member {String} disabledReasonCode
 */
PaymentChannelSummaryV4.prototype['disabledReasonCode'] = undefined;
...
export default PaymentChannelSummaryV4;
