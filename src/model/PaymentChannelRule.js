...
class PaymentChannelRule {
     ...
     */
    constructor(element, required, displayName, validation) { 
     ...
     */
    static initialize(obj, element, required, displayName, validation) { 
        obj['element'] = element;
...
PaymentChannelRule.RequiredProperties = ["element", "required", "displayName", "validation"];
