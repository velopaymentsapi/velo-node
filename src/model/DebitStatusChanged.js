...
class DebitStatusChanged {
     ...
     */
    constructor(sourceType, eventId, createdAt, debitTransactionId, status) { 
        DebitEvent.initialize(this, sourceType, eventId, createdAt, debitTransactionId);DebitStatusChangedAllOf.initialize(this, status);
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt, debitTransactionId, status) { 
...
DebitStatusChanged.RequiredProperties = ["sourceType", "eventId", "createdAt", "debitTransactionId", "status"];
