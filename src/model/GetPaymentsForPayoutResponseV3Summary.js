...
class GetPaymentsForPayoutResponseV3Summary {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('failedPayments')) {
                obj['failedPayments'] = ApiClient.convertToType(data['failedPayments'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPaymentsForPayoutResponseV3Summary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPaymentsForPayoutResponseV3Summary</code>.
     */
...
export default GetPaymentsForPayoutResponseV3Summary;
