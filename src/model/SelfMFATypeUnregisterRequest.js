...
class SelfMFATypeUnregisterRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>SelfMFATypeUnregisterRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SelfMFATypeUnregisterRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SelfMFATypeUnregisterRequest.RequiredProperties) {
            if (!data[property]) {
...
SelfMFATypeUnregisterRequest.RequiredProperties = ["mfaType"];
...
export default SelfMFATypeUnregisterRequest;
