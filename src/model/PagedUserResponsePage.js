...
class PagedUserResponsePage {
    ...
    /**
     * Validates the JSON data with respect to <code>PagedUserResponsePage</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PagedUserResponsePage</code>.
     */
...
export default PagedUserResponsePage;
