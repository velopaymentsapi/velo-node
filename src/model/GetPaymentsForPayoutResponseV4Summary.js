...
import PayoutPayorV4 from './PayoutPayorV4';
import PayoutPrincipalV4 from './PayoutPrincipalV4';
import PayoutTypeV4 from './PayoutTypeV4';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payoutType')) {
                obj['payoutType'] = PayoutTypeV4.constructFromObject(data['payoutType']);
            }
            if (data.hasOwnProperty('submitting')) {
                obj['submitting'] = PayoutPayorV4.constructFromObject(data['submitting']);
            }
            if (data.hasOwnProperty('payoutFrom')) {
                obj['payoutFrom'] = PayoutPayorV4.constructFromObject(data['payoutFrom']);
            }
            if (data.hasOwnProperty('payoutTo')) {
                obj['payoutTo'] = PayoutPayorV4.constructFromObject(data['payoutTo']);
            }
            if (data.hasOwnProperty('quoted')) {
                obj['quoted'] = PayoutPrincipalV4.constructFromObject(data['quoted']);
            }
            if (data.hasOwnProperty('instructed')) {
                obj['instructed'] = PayoutPrincipalV4.constructFromObject(data['instructed']);
            }
            if (data.hasOwnProperty('withdrawn')) {
                obj['withdrawn'] = PayoutPrincipalV4.constructFromObject(data['withdrawn']);
            }
        }
        return obj;
    }
