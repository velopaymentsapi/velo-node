...
class CreatePayeesCSVRequestV4 {
    /**
     * Constructs a new <code>CreatePayeesCSVRequestV4</code>.
     * @alias module:model/CreatePayeesCSVRequestV4
    ...
    constructor(type, remoteId, email, addressLine1, addressCity, addressZipOrPostcode, addressCountry) { 
        ...
        CreatePayeesCSVRequestV4.initialize(this, type, remoteId, email, addressLine1, addressCity, addressZipOrPostcode, addressCountry);
    }
    ...
    /**
     * Constructs a <code>CreatePayeesCSVRequestV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePayeesCSVRequestV4} obj Optional instance to populate.
     * @return {module:model/CreatePayeesCSVRequestV4} The populated <code>CreatePayeesCSVRequestV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePayeesCSVRequestV4();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePayeesCSVRequestV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePayeesCSVRequestV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePayeesCSVRequestV4.RequiredProperties) {
            if (!data[property]) {
...
CreatePayeesCSVRequestV4.RequiredProperties = ["type", "remoteId", "email", "addressLine1", "addressCity", "addressZipOrPostcode", "addressCountry"];

/**
 * @member {module:model/PayeeTypeEnum} type
 */
CreatePayeesCSVRequestV4.prototype['type'] = undefined;

/**
 * @member {String} remoteId
 */
CreatePayeesCSVRequestV4.prototype['remoteId'] = undefined;

/**
 * @member {String} email
 */
CreatePayeesCSVRequestV4.prototype['email'] = undefined;

/**
 * @member {String} addressLine1
 */
CreatePayeesCSVRequestV4.prototype['addressLine1'] = undefined;

/**
 * @member {String} addressLine2
 */
CreatePayeesCSVRequestV4.prototype['addressLine2'] = undefined;

/**
 * @member {String} addressLine3
 */
CreatePayeesCSVRequestV4.prototype['addressLine3'] = undefined;

/**
 * @member {String} addressLine4
 */
CreatePayeesCSVRequestV4.prototype['addressLine4'] = undefined;

/**
 * @member {String} addressCity
 */
CreatePayeesCSVRequestV4.prototype['addressCity'] = undefined;

/**
 * @member {String} addressCountyOrProvince
 */
CreatePayeesCSVRequestV4.prototype['addressCountyOrProvince'] = undefined;

/**
 * @member {String} addressZipOrPostcode
 */
CreatePayeesCSVRequestV4.prototype['addressZipOrPostcode'] = undefined;
 ...
 */
CreatePayeesCSVRequestV4.prototype['addressCountry'] = undefined;

/**
 * @member {String} individualNationalIdentification
 */
CreatePayeesCSVRequestV4.prototype['individualNationalIdentification'] = undefined;

/**
 * Must not be date in future. Example - 1970-05-20
 * @member {Date} individualDateOfBirth
 */
CreatePayeesCSVRequestV4.prototype['individualDateOfBirth'] = undefined;

/**
 * @member {String} individualTitle
 */
CreatePayeesCSVRequestV4.prototype['individualTitle'] = undefined;

/**
 * @member {String} individualFirstName
 */
CreatePayeesCSVRequestV4.prototype['individualFirstName'] = undefined;

/**
 * @member {String} individualOtherNames
 */
CreatePayeesCSVRequestV4.prototype['individualOtherNames'] = undefined;

/**
 * @member {String} individualLastName
 */
CreatePayeesCSVRequestV4.prototype['individualLastName'] = undefined;

/**
 * @member {String} companyName
 */
CreatePayeesCSVRequestV4.prototype['companyName'] = undefined;

/**
 * @member {String} companyEIN
 */
CreatePayeesCSVRequestV4.prototype['companyEIN'] = undefined;

/**
 * @member {String} companyOperatingName
 */
CreatePayeesCSVRequestV4.prototype['companyOperatingName'] = undefined;

/**
 * Either routing number and account number or only iban must be set
 * @member {String} paymentChannelAccountNumber
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelAccountNumber'] = undefined;

/**
 * Either routing number and account number or only iban must be set
 * @member {String} paymentChannelRoutingNumber
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelRoutingNumber'] = undefined;

/**
 * @member {String} paymentChannelAccountName
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelAccountName'] = undefined;

/**
 * Must match the regular expression ```^[A-Za-z0-9]+$```.
 * @member {String} paymentChannelIban
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelIban'] = undefined;

/**
 * Valid ISO 3166 2 character country code. See the <a href=\"https://www.iso.org/iso-3166-country-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
 * @member {String} paymentChannelCountryCode
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelCountryCode'] = undefined;

/**
 * @member {String} paymentChannelCurrency
 */
CreatePayeesCSVRequestV4.prototype['paymentChannelCurrency'] = undefined;

/**
 * @member {String} challengeDescription
 */
CreatePayeesCSVRequestV4.prototype['challengeDescription'] = undefined;

/**
 * @member {String} challengeValue
 */
CreatePayeesCSVRequestV4.prototype['challengeValue'] = undefined;
 ...
 */
CreatePayeesCSVRequestV4.prototype['payeeLanguage'] = undefined;
...
export default CreatePayeesCSVRequestV4;
