...
/**
 * The PayorFundingDetectedAllOf model module.
 * @module model/PayorFundingDetectedAllOf
 * @version 2.37.150-beta.1
 */
class PayorFundingDetectedAllOf {
    /**
     * Constructs a new <code>PayorFundingDetectedAllOf</code>.
     * @alias module:model/PayorFundingDetectedAllOf
     ...
     */
    constructor(payorId, fundingRequestId) { 
        
        PayorFundingDetectedAllOf.initialize(this, payorId, fundingRequestId);
    }
     ...
     */
    static initialize(obj, payorId, fundingRequestId) { 
        obj['payorId'] = payorId;
        obj['fundingRequestId'] = fundingRequestId;
    }

    /**
     * Constructs a <code>PayorFundingDetectedAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayorFundingDetectedAllOf} obj Optional instance to populate.
     * @return {module:model/PayorFundingDetectedAllOf} The populated <code>PayorFundingDetectedAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayorFundingDetectedAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>PayorFundingDetectedAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayorFundingDetectedAllOf</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayorFundingDetectedAllOf.RequiredProperties) {
            if (!data[property]) {
...
PayorFundingDetectedAllOf.RequiredProperties = ["payorId", "fundingRequestId"];
...
export default PayorFundingDetectedAllOf;
