...
class FundingRequestV3 {
     ...
     */
    constructor(fundingAccountId, amount) { 
     ...
     */
    static initialize(obj, fundingAccountId, amount) { 
    ...
    /**
     * Validates the JSON data with respect to <code>FundingRequestV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundingRequestV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FundingRequestV3.RequiredProperties) {
            if (!data[property]) {
...
FundingRequestV3.RequiredProperties = ["fundingAccountId", "amount"];
...
export default FundingRequestV3;
