...
import PagedPayeeInvitationStatusResponsePage from './PagedPayeeInvitationStatusResponsePage';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('page')) {
                obj['page'] = PagedPayeeInvitationStatusResponsePage.constructFromObject(data['page']);
            }
