...
import PayeePaymentChannel2 from './PayeePaymentChannel2';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paymentChannel')) {
                obj['paymentChannel'] = PayeePaymentChannel2.constructFromObject(data['paymentChannel']);
            }
