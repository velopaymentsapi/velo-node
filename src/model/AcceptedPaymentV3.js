...
class AcceptedPaymentV3 {
     ...
     */
    constructor(remoteId, currencyType, amount, sourceAccountName, payorPaymentId, railsId) { 
        
        AcceptedPaymentV3.initialize(this, remoteId, currencyType, amount, sourceAccountName, payorPaymentId, railsId);
    }
     ...
     */
    static initialize(obj, remoteId, currencyType, amount, sourceAccountName, payorPaymentId, railsId) { 
...
AcceptedPaymentV3.RequiredProperties = ["remoteId", "currencyType", "amount", "sourceAccountName", "payorPaymentId", "railsId"];
