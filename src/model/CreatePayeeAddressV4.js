...
/**
 * The CreatePayeeAddressV4 model module.
 * @module model/CreatePayeeAddressV4
 * @version 2.37.150-beta.1
 */
class CreatePayeeAddressV4 {
    /**
     * Constructs a new <code>CreatePayeeAddressV4</code>.
     * @alias module:model/CreatePayeeAddressV4
     * @param line1 {String} 
     * @param city {String} 
    ...
    constructor(line1, city, country) { 
        ...
        CreatePayeeAddressV4.initialize(this, line1, city, country);
    }
    ...
    /**
     * Constructs a <code>CreatePayeeAddressV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePayeeAddressV4} obj Optional instance to populate.
     * @return {module:model/CreatePayeeAddressV4} The populated <code>CreatePayeeAddressV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePayeeAddressV4();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePayeeAddressV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePayeeAddressV4</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePayeeAddressV4.RequiredProperties) {
            if (!data[property]) {
...
CreatePayeeAddressV4.RequiredProperties = ["line1", "city", "country"];

/**
 * @member {String} line1
 */
CreatePayeeAddressV4.prototype['line1'] = undefined;

/**
 * @member {String} line2
 */
CreatePayeeAddressV4.prototype['line2'] = undefined;

/**
 * @member {String} line3
 */
CreatePayeeAddressV4.prototype['line3'] = undefined;

/**
 * @member {String} line4
 */
CreatePayeeAddressV4.prototype['line4'] = undefined;

/**
 * @member {String} city
 */
CreatePayeeAddressV4.prototype['city'] = undefined;

/**
 * @member {String} countyOrProvince
 */
CreatePayeeAddressV4.prototype['countyOrProvince'] = undefined;

/**
 * @member {String} zipOrPostcode
 */
CreatePayeeAddressV4.prototype['zipOrPostcode'] = undefined;
 ...
 */
CreatePayeeAddressV4.prototype['country'] = undefined;
...
export default CreatePayeeAddressV4;
