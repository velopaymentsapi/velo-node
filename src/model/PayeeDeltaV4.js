...
class PayeeDeltaV4 {
     ...
     */
    constructor(remoteId, payeeId) { 
        
        PayeeDeltaV4.initialize(this, remoteId, payeeId);
    }
     ...
     */
    static initialize(obj, remoteId, payeeId) { 
...
PayeeDeltaV4.RequiredProperties = ["remoteId", "payeeId"];
