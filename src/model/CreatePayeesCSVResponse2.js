...
import CreatePayeesCSVResponseRejectedCsvRows from './CreatePayeesCSVResponseRejectedCsvRows';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('rejectedCsvRows')) {
                obj['rejectedCsvRows'] = ApiClient.convertToType(data['rejectedCsvRows'], [CreatePayeesCSVResponseRejectedCsvRows]);
            }
        }
        return obj;
    }
...
export default CreatePayeesCSVResponse2;
