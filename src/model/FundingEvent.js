...
class FundingEvent {
     ...
     */
    constructor(sourceType, eventId, createdAt) { 
        SourceEvent.initialize(this, sourceType, eventId, createdAt);
        FundingEvent.initialize(this, sourceType, eventId, createdAt);
    }
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of FundingEvent.RequiredProperties) {
            if (!data[property]) {
...
FundingEvent.RequiredProperties = ["sourceType", "eventId", "createdAt"];
