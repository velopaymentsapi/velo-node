...
class PayoutSummaryAudit {
     ...
     */
    constructor(payoutId, payorId, status, submittedDateTime) { 
        
        PayoutSummaryAudit.initialize(this, payoutId, payorId, status, submittedDateTime);
    }
     ...
     */
    static initialize(obj, payoutId, payorId, status, submittedDateTime) { 
 ...
 */
PayoutSummaryAudit.prototype['totalFailedPayments'] = undefined;
