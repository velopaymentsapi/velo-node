...
class PayeeInvitationStatusResponse {
     ...
     * @param invitationStatus {module:model/InvitationStatus} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('invitationStatus')) {
                obj['invitationStatus'] = InvitationStatus.constructFromObject(data['invitationStatus']);
            }
...
export default PayeeInvitationStatusResponse;
