...
class PayoutSummaryResponse {
     ...
     * @param fxSummaries {Array.<module:model/FxSummaries>} 
     * @param accounts {Array.<module:model/SourceAccount>} 
     * @param rejectedPayments {Array.<module:model/RejectedPayment>} 
     */
    constructor(fxSummaries, accounts, rejectedPayments) { 
        
        PayoutSummaryResponse.initialize(this, fxSummaries, accounts, rejectedPayments);
    }
     ...
     */
    static initialize(obj, fxSummaries, accounts, rejectedPayments) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fxSummaries')) {
                obj['fxSummaries'] = ApiClient.convertToType(data['fxSummaries'], [FxSummaries]);
            }
...
/**
 * @member {Array.<module:model/FxSummaries>} fxSummaries
 */
