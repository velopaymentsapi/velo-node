...
class SourceAccountResponseV2 {
     ...
     * @param autoTopUpConfig {module:model/AutoTopUpConfig} 
     */
    constructor(id, fundingRef, physicalAccountName, railsId, pooled, balanceVisible, autoTopUpConfig) { 
        
        SourceAccountResponseV2.initialize(this, id, fundingRef, physicalAccountName, railsId, pooled, balanceVisible, autoTopUpConfig);
    }
     ...
     */
    static initialize(obj, id, fundingRef, physicalAccountName, railsId, pooled, balanceVisible, autoTopUpConfig) { 
        obj['id'] = id;
        ...
        obj['autoTopUpConfig'] = autoTopUpConfig;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('autoTopUpConfig')) {
                obj['autoTopUpConfig'] = AutoTopUpConfig.constructFromObject(data['autoTopUpConfig']);
            }
        }
        return obj;
    }
