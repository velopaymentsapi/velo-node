...
class GetPayoutsResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ApiClient.convertToType(data['content'], [PayoutSummaryAudit]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetPayoutsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetPayoutsResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
            ...
            for (const item of data['content']) {
                PayoutSummaryAudit.validateJSON(item);
            };
        }
...
export default GetPayoutsResponse;
