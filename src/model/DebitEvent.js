...
import DebitEventAllOf from './DebitEventAllOf';
...
class DebitEvent {
     ...
     */
    constructor(sourceType, eventId, createdAt, debitTransactionId) { 
        SourceEvent.initialize(this, sourceType, eventId, createdAt);DebitEventAllOf.initialize(this, debitTransactionId);
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt, debitTransactionId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            DebitEventAllOf.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DebitEvent</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DebitEvent</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DebitEvent.RequiredProperties) {
            if (!data[property]) {
...
DebitEvent.RequiredProperties = ["sourceType", "eventId", "createdAt", "debitTransactionId"];
...
// Implement DebitEventAllOf interface:
/**
 * ID of this debit transaction within the Velo platform
 * @member {String} debitTransactionId
 */
