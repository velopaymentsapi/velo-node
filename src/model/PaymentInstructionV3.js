...
PaymentInstructionV3.RequiredProperties = ["remoteId", "currency", "amount", "sourceAccountName"];
 ...
 * @member {module:model/PaymentInstructionV3.TransmissionTypeEnum} transmissionType
 */
...
/**
 * Allowed values for the <code>transmissionType</code> property.
 * @enum {String}
 * @readonly
 */
PaymentInstructionV3['TransmissionTypeEnum'] = {
