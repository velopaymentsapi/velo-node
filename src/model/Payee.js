...
import IndividualV1 from './IndividualV1';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('company')) {
                obj['company'] = CompanyV1.constructFromObject(data['company']);
            }
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = IndividualV1.constructFromObject(data['individual']);
            }
