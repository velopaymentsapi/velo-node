    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paymentChannel')) {
                obj['paymentChannel'] = PaymentChannel.constructFromObject(data['paymentChannel']);
            }
...
/**
 * @member {module:model/PaymentChannel} paymentChannel
 */
 ...
 */
Payee.prototype['social'] = undefined;
