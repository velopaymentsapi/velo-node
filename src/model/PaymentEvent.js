...
import PaymentEventAllOf from './PaymentEventAllOf';
...
class PaymentEvent {
     ...
     */
    constructor(sourceType, eventId, createdAt, paymentId) { 
        SourceEvent.initialize(this, sourceType, eventId, createdAt);PaymentEventAllOf.initialize(this, paymentId);
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt, paymentId) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PaymentEventAllOf.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of PaymentEvent.RequiredProperties) {
            if (!data[property]) {
...
PaymentEvent.RequiredProperties = ["sourceType", "eventId", "createdAt", "paymentId"];
...
// Implement PaymentEventAllOf interface:
/**
 * ID of this payment within the Velo platform
 * @member {String} paymentId
 */
