...
class OnboardingStatusChanged {
     ...
     */
    constructor(sourceType, eventId, createdAt, payeeId) { 
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt, payeeId) { 
    ...
    /**
     * Validates the JSON data with respect to <code>OnboardingStatusChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OnboardingStatusChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OnboardingStatusChanged.RequiredProperties) {
            if (!data[property]) {
...
OnboardingStatusChanged.RequiredProperties = ["sourceType", "eventId", "createdAt", "payeeId"];
 ...
 */
OnboardingStatusChanged.prototype['reasons'] = undefined;
...
export default OnboardingStatusChanged;
