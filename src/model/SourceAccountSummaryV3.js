...
class SourceAccountSummaryV3 {
    ...
    /**
     * Validates the JSON data with respect to <code>SourceAccountSummaryV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SourceAccountSummaryV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SourceAccountSummaryV3.RequiredProperties) {
            if (!data[property]) {
...
SourceAccountSummaryV3.RequiredProperties = ["sourceAccountId", "totalCost"];
...
export default SourceAccountSummaryV3;
