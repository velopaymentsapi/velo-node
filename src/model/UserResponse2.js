...
import UserResponse2Roles from './UserResponse2Roles';

/**
 * The UserResponse2 model module.
 * @module model/UserResponse2
 * @version 2.18.113
 */
class UserResponse2 {
    /**
     * Constructs a new <code>UserResponse2</code>.
     * @alias module:model/UserResponse2
     */
    constructor() { 
        
        UserResponse2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserResponse2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserResponse2} obj Optional instance to populate.
     * @return {module:model/UserResponse2} The populated <code>UserResponse2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('roles')) {
                obj['roles'] = ApiClient.convertToType(data['roles'], [UserResponse2Roles]);
            }
            if (data.hasOwnProperty('mfaType')) {
                obj['mfaType'] = ApiClient.convertToType(data['mfaType'], 'String');
            }
            if (data.hasOwnProperty('mfaVerified')) {
                obj['mfaVerified'] = ApiClient.convertToType(data['mfaVerified'], 'Boolean');
            }
 ...
 * @member {String} id
 */
UserResponse2.prototype['id'] = undefined;

/**
 * The status of the user when the user has been invited but not yet enrolled they will have a PENDING status 
 * @member {module:model/UserResponse2.StatusEnum} status
 */
UserResponse2.prototype['status'] = undefined;

/**
 * the email address of the user
 * @member {String} email
 */
UserResponse2.prototype['email'] = undefined;

/**
 * The phone number of a device that the user can receive sms messages on 
 * @member {String} smsNumber
 */
UserResponse2.prototype['smsNumber'] = undefined;

/**
 * The main contact number for the user 
 * @member {String} primaryContactNumber
 */
UserResponse2.prototype['primaryContactNumber'] = undefined;

/**
 * The secondary contact number for the user 
 * @member {String} secondaryContactNumber
 */
UserResponse2.prototype['secondaryContactNumber'] = undefined;

/**
 * @member {String} firstName
 */
UserResponse2.prototype['firstName'] = undefined;

/**
 * @member {String} lastName
 */
UserResponse2.prototype['lastName'] = undefined;

/**
 * The payorId or payeeId or null if the user is not a payor or payee user 
 * @member {String} entityId
 */
UserResponse2.prototype['entityId'] = undefined;

/**
 * The role(s) for the user 
 * @member {Array.<module:model/UserResponse2Roles>} roles
 */
UserResponse2.prototype['roles'] = undefined;

/**
 * The type of the MFA device
 * @member {module:model/UserResponse2.MfaTypeEnum} mfaType
 */
UserResponse2.prototype['mfaType'] = undefined;

/**
 * Will be true if the user has logged in successfully using the MFA Device 
 * @member {Boolean} mfaVerified
 */
UserResponse2.prototype['mfaVerified'] = undefined;

/**
 * The status of the MFA device
 * @member {module:model/UserResponse2.MfaStatusEnum} mfaStatus
 */
UserResponse2.prototype['mfaStatus'] = undefined;

/**
 * If true the user is currently locked out and unable to log in
 * @member {Boolean} lockedOut
 */
UserResponse2.prototype['lockedOut'] = undefined;
 ...
 */
UserResponse2.prototype['lockedOutTimestamp'] = undefined;
