...
import GetPayoutsResponseV3Summary from './GetPayoutsResponseV3Summary';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('summary')) {
                obj['summary'] = GetPayoutsResponseV3Summary.constructFromObject(data['summary']);
            }
...
/**
 * @member {module:model/GetPayoutsResponseV3Summary} summary
 */
GetPayoutsResponseV3.prototype['summary'] = undefined;
