...
class SupportedCountriesResponseV2 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('countries')) {
                obj['countries'] = ApiClient.convertToType(data['countries'], [SupportedCountryV2]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SupportedCountriesResponseV2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SupportedCountriesResponseV2</code>.
     */
    static validateJSON(data) {
        if (data['countries']) { // data not null
            ...
            for (const item of data['countries']) {
                SupportedCountryV2.validateJSON(item);
            };
        }
...
export default SupportedCountriesResponseV2;
