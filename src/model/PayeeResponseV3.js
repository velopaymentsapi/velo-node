...
import OnboardedStatus2 from './OnboardedStatus2';
...
/**
 * The PayeeResponseV3 model module.
 * @module model/PayeeResponseV3
 * @version 2.20.118
 */
class PayeeResponseV3 {
    /**
     * Constructs a new <code>PayeeResponseV3</code>.
     * @alias module:model/PayeeResponseV3
     */
    constructor() { 
        
        PayeeResponseV3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PayeeResponseV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayeeResponseV3} obj Optional instance to populate.
     * @return {module:model/PayeeResponseV3} The populated <code>PayeeResponseV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayeeResponseV3();
            ...
            if (data.hasOwnProperty('onboardedStatus')) {
                obj['onboardedStatus'] = OnboardedStatus2.constructFromObject(data['onboardedStatus']);
            }
            ...
            if (data.hasOwnProperty('language')) {
                obj['language'] = Language2.constructFromObject(data['language']);
            }
 ...
 */
PayeeResponseV3.prototype['payeeId'] = undefined;

/**
 * @member {Array.<module:model/PayeePayorRefV3>} payorRefs
 */
PayeeResponseV3.prototype['payorRefs'] = undefined;

/**
 * @member {String} email
 */
PayeeResponseV3.prototype['email'] = undefined;

/**
 * @member {module:model/OnboardedStatus2} onboardedStatus
 */
PayeeResponseV3.prototype['onboardedStatus'] = undefined;

/**
 * @member {module:model/WatchlistStatus} watchlistStatus
 */
PayeeResponseV3.prototype['watchlistStatus'] = undefined;

/**
 * @member {Date} watchlistOverrideExpiresAtTimestamp
 */
PayeeResponseV3.prototype['watchlistOverrideExpiresAtTimestamp'] = undefined;

/**
 * @member {String} watchlistOverrideComment
 */
PayeeResponseV3.prototype['watchlistOverrideComment'] = undefined;

/**
 * @member {module:model/Language2} language
 */
PayeeResponseV3.prototype['language'] = undefined;

/**
 * @member {Date} created
 */
PayeeResponseV3.prototype['created'] = undefined;

/**
 * @member {String} country
 */
PayeeResponseV3.prototype['country'] = undefined;

/**
 * @member {String} displayName
 */
PayeeResponseV3.prototype['displayName'] = undefined;

/**
 * @member {module:model/PayeeType} payeeType
 */
PayeeResponseV3.prototype['payeeType'] = undefined;

/**
 * @member {Boolean} disabled
 */
PayeeResponseV3.prototype['disabled'] = undefined;

/**
 * @member {String} disabledComment
 */
PayeeResponseV3.prototype['disabledComment'] = undefined;

/**
 * @member {Date} disabledUpdatedTimestamp
 */
PayeeResponseV3.prototype['disabledUpdatedTimestamp'] = undefined;

/**
 * @member {module:model/PayeeAddress2} address
 */
PayeeResponseV3.prototype['address'] = undefined;

/**
 * @member {module:model/Individual2} individual
 */
PayeeResponseV3.prototype['individual'] = undefined;

/**
 * @member {module:model/Company2} company
 */
PayeeResponseV3.prototype['company'] = undefined;

/**
 * @member {String} cellphoneNumber
 */
PayeeResponseV3.prototype['cellphoneNumber'] = undefined;

/**
 * @member {String} watchlistStatusUpdatedTimestamp
 */
PayeeResponseV3.prototype['watchlistStatusUpdatedTimestamp'] = undefined;

/**
 * @member {Date} gracePeriodEndDate
 */
PayeeResponseV3.prototype['gracePeriodEndDate'] = undefined;

/**
 * @member {Boolean} enhancedKycCompleted
 */
PayeeResponseV3.prototype['enhancedKycCompleted'] = undefined;

/**
 * @member {String} kycCompletedTimestamp
 */
PayeeResponseV3.prototype['kycCompletedTimestamp'] = undefined;

/**
 * @member {Boolean} pausePayment
 */
PayeeResponseV3.prototype['pausePayment'] = undefined;

/**
 * @member {String} pausePaymentTimestamp
 */
PayeeResponseV3.prototype['pausePaymentTimestamp'] = undefined;

/**
 * @member {Boolean} marketingOptInDecision
 */
PayeeResponseV3.prototype['marketingOptInDecision'] = undefined;

/**
 * @member {String} marketingOptInTimestamp
 */
PayeeResponseV3.prototype['marketingOptInTimestamp'] = undefined;

/**
 * The timestamp when the payee last accepted T&Cs
 * @member {Date} acceptTermsAndConditionsTimestamp
 */
PayeeResponseV3.prototype['acceptTermsAndConditionsTimestamp'] = undefined;
...
export default PayeeResponseV3;
