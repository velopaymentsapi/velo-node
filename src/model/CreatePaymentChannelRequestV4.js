...
/**
 * The CreatePaymentChannelRequestV4 model module.
 * @module model/CreatePaymentChannelRequestV4
 * @version 2.37.150-beta.1
 */
class CreatePaymentChannelRequestV4 {
    /**
     * Constructs a new <code>CreatePaymentChannelRequestV4</code>.
     * @alias module:model/CreatePaymentChannelRequestV4
     */
    constructor() { 
        
        CreatePaymentChannelRequestV4.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreatePaymentChannelRequestV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreatePaymentChannelRequestV4} obj Optional instance to populate.
     * @return {module:model/CreatePaymentChannelRequestV4} The populated <code>CreatePaymentChannelRequestV4</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreatePaymentChannelRequestV4();
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePaymentChannelRequestV4</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePaymentChannelRequestV4</code>.
     */
 ...
 */
CreatePaymentChannelRequestV4.prototype['paymentChannelName'] = undefined;

/**
 * Must match the regular expression ```^[A-Za-z0-9]+$```.
 * @member {String} iban
 */
CreatePaymentChannelRequestV4.prototype['iban'] = undefined;

/**
 * @member {String} accountNumber
 */
CreatePaymentChannelRequestV4.prototype['accountNumber'] = undefined;

/**
 * @member {String} routingNumber
 */
CreatePaymentChannelRequestV4.prototype['routingNumber'] = undefined;
 ...
 */
CreatePaymentChannelRequestV4.prototype['countryCode'] = undefined;

/**
 * Valid ISO 4217 3 letter currency code. See the <a href=\"https://www.iso.org/iso-4217-currency-codes.html\" target=\"_blank\" a>ISO specification</a> for details.
 * @member {String} currency
 */
CreatePaymentChannelRequestV4.prototype['currency'] = undefined;

/**
 * @member {String} accountName
 */
CreatePaymentChannelRequestV4.prototype['accountName'] = undefined;
...
export default CreatePaymentChannelRequestV4;
