...
class FxSummary {
     ...
     */
    constructor(quoteId, creationDateTime, rate, invertedRate, totalCost, totalPaymentAmount, status, fundingStatus) { 
     ...
     */
    static initialize(obj, quoteId, creationDateTime, rate, invertedRate, totalCost, totalPaymentAmount, status, fundingStatus) { 
        obj['quoteId'] = quoteId;
    ...
    /**
     * Validates the JSON data with respect to <code>FxSummary</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FxSummary</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FxSummary.RequiredProperties) {
            if (!data[property]) {
...
FxSummary.RequiredProperties = ["quoteId", "creationDateTime", "rate", "invertedRate", "totalCost", "totalPaymentAmount", "status", "fundingStatus"];
