...
class PayoutPayor {
     ...
     */
    constructor(payorId, payorName, dbaName, principal, principalId) { 
     ...
     */
    static initialize(obj, payorId, payorName, dbaName, principal, principalId) { 
        obj['payorId'] = payorId;
...
PayoutPayor.RequiredProperties = ["payorId", "payorName", "dbaName", "principal", "principalId"];
