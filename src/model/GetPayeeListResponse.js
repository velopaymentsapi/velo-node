    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = GetPayeeListResponseIndividual.constructFromObject(data['individual']);
            }
            if (data.hasOwnProperty('company')) {
                obj['company'] = GetPayeeListResponseCompany.constructFromObject(data['company']);
            }
        }
        return obj;
    }
...
export default GetPayeeListResponse;
