...
class PaymentEventResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('principle')) {
                obj['principle'] = ApiClient.convertToType(data['principle'], 'String');
            }
        }
        return obj;
    }
...
/**
 * @member {String} principle
 */
PaymentEventResponse.prototype['principle'] = undefined;
