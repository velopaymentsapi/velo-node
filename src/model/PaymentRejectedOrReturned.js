...
class PaymentRejectedOrReturned {
     ...
     */
    constructor(sourceType, eventId, createdAt, paymentId, status, reasonCode, reasonMessage) { 
        PaymentStatusChanged.initialize(this, sourceType, eventId, createdAt, paymentId, status);PaymentRejectedOrReturnedAllOf.initialize(this, reasonCode, reasonMessage);
     ...
     */
    static initialize(obj, sourceType, eventId, createdAt, paymentId, status, reasonCode, reasonMessage) { 
...
PaymentRejectedOrReturned.RequiredProperties = ["sourceType", "eventId", "createdAt", "paymentId", "status", "reasonCode", "reasonMessage"];
