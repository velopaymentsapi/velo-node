...
class Notification {
     ...
     */
    constructor(apiVersion, sequenceNumber, category, eventName) { 
     ...
     */
    static initialize(obj, apiVersion, sequenceNumber, category, eventName) { 
...
Notification.RequiredProperties = ["apiVersion", "sequenceNumber", "category", "eventName"];
