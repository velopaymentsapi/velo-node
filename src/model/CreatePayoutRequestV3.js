...
class CreatePayoutRequestV3 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('payments')) {
                obj['payments'] = ApiClient.convertToType(data['payments'], [PaymentInstructionV3]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreatePayoutRequestV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreatePayoutRequestV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreatePayoutRequestV3.RequiredProperties) {
            if (!data[property]) {
...
CreatePayoutRequestV3.RequiredProperties = ["payments"];
...
export default CreatePayoutRequestV3;
