...
/**
 * The SourceAccount model module.
 * @module model/SourceAccount
 * @version 2.10.61
 */
class SourceAccount {
    /**
     * Constructs a new <code>SourceAccount</code>.
     * @alias module:model/SourceAccount
    ...
    constructor(sourceAccountName, sourceAccountId, currency, totalPayoutCost) { 
        ...
        SourceAccount.initialize(this, sourceAccountName, sourceAccountId, currency, totalPayoutCost);
    }
    ...
    /**
     * Constructs a <code>SourceAccount</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SourceAccount} obj Optional instance to populate.
     * @return {module:model/SourceAccount} The populated <code>SourceAccount</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SourceAccount();
 ...
 */
SourceAccount.prototype['sourceAccountName'] = undefined;

/**
 * @member {String} sourceAccountId
 */
SourceAccount.prototype['sourceAccountId'] = undefined;

/**
 * @member {String} currency
 */
SourceAccount.prototype['currency'] = undefined;

/**
 * @member {Number} totalPayoutCost
 */
SourceAccount.prototype['totalPayoutCost'] = undefined;
