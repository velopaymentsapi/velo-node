...
class PayeeDetailsChanged {
    ...
    /**
     * Validates the JSON data with respect to <code>PayeeDetailsChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayeeDetailsChanged</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayeeDetailsChanged.RequiredProperties) {
            if (!data[property]) {
...
PayeeDetailsChanged.RequiredProperties = ["sourceType", "eventId", "createdAt", "payeeId"];
 ...
 */
PayeeDetailsChanged.prototype['reasons'] = undefined;
...
export default PayeeDetailsChanged;
