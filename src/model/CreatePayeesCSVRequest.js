...
class CreatePayeesCSVRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('paymentChannelRoutingNo')) {
                obj['paymentChannelRoutingNo'] = ApiClient.convertToType(data['paymentChannelRoutingNo'], 'String');
            }
 ...
 */
CreatePayeesCSVRequest.prototype['companyTaxId'] = undefined;
...
/**
 * @member {String} paymentChannelRoutingNo
 */
CreatePayeesCSVRequest.prototype['paymentChannelRoutingNo'] = undefined;
