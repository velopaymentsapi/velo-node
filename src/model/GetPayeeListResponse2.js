    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('individual')) {
                obj['individual'] = GetPayeeListResponseIndividual2.constructFromObject(data['individual']);
            }
            if (data.hasOwnProperty('company')) {
                obj['company'] = GetPayeeListResponseCompany2.constructFromObject(data['company']);
            }
        }
        return obj;
    }
...
export default GetPayeeListResponse2;
