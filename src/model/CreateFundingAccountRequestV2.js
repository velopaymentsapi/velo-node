...
class CreateFundingAccountRequestV2 {
     ...
     * @param countryCode {String} ISO 3166-1 2 letter country code (upper case)
     */
    constructor(type, name, payorId, countryCode) { 
        
        CreateFundingAccountRequestV2.initialize(this, type, name, payorId, countryCode);
    }
     ...
     */
    static initialize(obj, type, name, payorId, countryCode) { 
        obj['type'] = type;
        obj['name'] = name;
        obj['payorId'] = payorId;
...
CreateFundingAccountRequestV2.RequiredProperties = ["type", "name", "payorId", "countryCode"];
 ...
 */
CreateFundingAccountRequestV2.prototype['countryCode'] = undefined;
