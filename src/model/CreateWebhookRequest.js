...
class CreateWebhookRequest {
     ...
     */
    constructor(payorId, webhookUrl, enabled) { 
     ...
     */
    static initialize(obj, payorId, webhookUrl, enabled) { 
        obj['payorId'] = payorId;
...
CreateWebhookRequest.RequiredProperties = ["payorId", "webhookUrl", "enabled"];
