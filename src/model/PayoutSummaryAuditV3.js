...
class PayoutSummaryAuditV3 {
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutSummaryAuditV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutSummaryAuditV3</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutSummaryAuditV3.RequiredProperties) {
            if (!data[property]) {
        ...
        // ensure the json data is a string
        if (data['withdrawnDateTime'] && !(typeof data['withdrawnDateTime'] === 'string' || data['withdrawnDateTime'] instanceof String)) {
            throw new Error("Expected the field `withdrawnDateTime` to be a primitive type in the JSON string but got " + data['withdrawnDateTime']);
        }
        if (data['sourceAccountSummary']) { // data not null
            ...
            for (const item of data['sourceAccountSummary']) {
                SourceAccountSummaryV3.validateJSON(item);
            };
        }
...
PayoutSummaryAuditV3.RequiredProperties = ["payoutId", "status", "submittedDateTime"];
