...
class PayoutPrincipal {
     ...
     */
    static initialize(obj, principal, principalId) { 
    ...
    /**
     * Validates the JSON data with respect to <code>PayoutPrincipal</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PayoutPrincipal</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PayoutPrincipal.RequiredProperties) {
            if (!data[property]) {
...
PayoutPrincipal.RequiredProperties = ["principal", "principalId"];
...
export default PayoutPrincipal;
