...
class PaymentInstruction {
     ...
     * @param currency {module:model/PaymentInstruction.CurrencyEnum} Payee's currency
     * @param amount {Number} Amount to send to Payee
     * @param sourceAccountName {String} 
     */
    constructor(remoteId, currency, amount, sourceAccountName) { 
        
        PaymentInstruction.initialize(this, remoteId, currency, amount, sourceAccountName);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PaymentInstruction();
 ...
 */
PaymentInstruction.prototype['remoteId'] = undefined;

/**
 * Payee's currency
 * @member {module:model/PaymentInstruction.CurrencyEnum} currency
 */
PaymentInstruction.prototype['currency'] = undefined;

/**
 * Amount to send to Payee
 * @member {Number} amount
 */
PaymentInstruction.prototype['amount'] = undefined;

/**
 * @member {String} paymentMemo
 */
PaymentInstruction.prototype['paymentMemo'] = undefined;

/**
 * @member {String} sourceAccountName
 */
PaymentInstruction.prototype['sourceAccountName'] = undefined;

/**
 * @member {String} payorPaymentId
 */
PaymentInstruction.prototype['payorPaymentId'] = undefined;
 ...
 * @readonly
 */
PaymentInstruction['CurrencyEnum'] = {
