...
/**
* PayorApplications service.
* @module api/PayorApplicationsApi
* @version 2.17.8
*/
export default class PayorApplicationsApi {

    /**
    * Constructs a new PayorApplicationsApi. 
    * @alias module:api/PayorApplicationsApi
    * @class
    ...
    */
     ...
     * @callback module:api/PayorApplicationsApi~payorCreateApiKeyRequestCallback
     ...
     * @param {module:api/PayorApplicationsApi~payorCreateApiKeyRequestCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PayorApplicationsApi~payorCreateApplicationRequestCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PayorApplicationsApi~payorCreateApplicationRequestCallback} callback The callback function, accepting three arguments: error, data, response
     */
