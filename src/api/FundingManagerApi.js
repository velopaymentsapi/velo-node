...
export default class FundingManagerApi {
    ...
    */
     ...
     * @callback module:api/FundingManagerApi~getFundingsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FundingManagerApi~getFundingsCallback} callback The callback function, accepting three arguments: error, data, response
