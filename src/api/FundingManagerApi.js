...
export default class FundingManagerApi {
    ...
    */
     ...
     */
    createAchFundingRequest(sourceAccountId, fundingRequest, callback) {
      ...
      if (fundingRequest === undefined || fundingRequest === null) {
        throw new Error("Missing the required parameter 'fundingRequest' when calling createAchFundingRequest");
      }
      ...
      return this.apiClient.callApi(
        '/v1/sourceAccounts/{sourceAccountId}/fundingRequest', 'POST',
     ...
     * @callback module:api/FundingManagerApi~listSourceAccountsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/FundingManagerApi~listSourceAccountsCallback} callback The callback function, accepting three arguments: error, data, response
