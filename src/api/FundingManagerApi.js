...
export default class FundingManagerApi {
    ...
    */
     ...
     * @param {module:model/FundingRequest} fundingRequest Body to included ammount to be funded
     ...
     */
    createFundingRequest(sourceAccountId, fundingRequest, callback) {
      let postBody = fundingRequest;
      ...
      if (fundingRequest === undefined || fundingRequest === null) {
        throw new Error("Missing the required parameter 'fundingRequest' when calling createFundingRequest");
      }
    ...
    /**
     * Callback function to receive the result of the setPayorFundingBankDetails operation.
     * @callback module:api/FundingManagerApi~setPayorFundingBankDetailsCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/PayorFundingBankDetailsUpdate} payorFundingBankDetailsUpdate Update Funding bank details of given Payor Id
     * @param {module:api/FundingManagerApi~setPayorFundingBankDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     */
    setPayorFundingBankDetails(payorId, payorFundingBankDetailsUpdate, callback) {
      let postBody = payorFundingBankDetailsUpdate;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling setPayorFundingBankDetails");
      }
      // verify the required parameter 'payorFundingBankDetailsUpdate' is set
      if (payorFundingBankDetailsUpdate === undefined || payorFundingBankDetailsUpdate === null) {
        throw new Error("Missing the required parameter 'payorFundingBankDetailsUpdate' when calling setPayorFundingBankDetails");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v1/payors/{payorId}/payorFundingBankDetailsUpdate', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
