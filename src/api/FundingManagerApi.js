...
export default class FundingManagerApi {
    ...
    */
    ...
    getFundingAccountV2(fundingAccountId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FundingAccountResponse2;
      return this.apiClient.callApi(
    ...
    getFundingAccountsV2(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ListFundingAccountsResponse2;
      return this.apiClient.callApi(
     ...
     */
    transferFundsV3(sourceAccountId, transferRequest2, callback) {
      let postBody = transferRequest2;
      // verify the required parameter 'sourceAccountId' is set
      if (sourceAccountId === undefined || sourceAccountId === null) {
