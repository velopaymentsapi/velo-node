...
export default class FundingManagerApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/FundingDeltaResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} payorId The Payor ID to find associated funding records
     ...
     * data is of type: {@link module:model/FundingDeltaResponse}
     */
    listFundingAuditDeltas(payorId, updatedSince, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = FundingDeltaResponse;
      return this.apiClient.callApi(
