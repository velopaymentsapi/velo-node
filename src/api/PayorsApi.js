...
export default class PayorsApi {
    ...
    */
     ...
     */
    payorLinks(descendantsOfPayor, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'descendantsOfPayor' is set
      if (descendantsOfPayor === undefined || descendantsOfPayor === null) {
        throw new Error("Missing the required parameter 'descendantsOfPayor' when calling payorLinks");
      }

      let pathParams = {
      };
      let queryParams = {
        'descendantsOfPayor': descendantsOfPayor,
        'fields': opts['fields']
      };
      let headerParams = {
      };
