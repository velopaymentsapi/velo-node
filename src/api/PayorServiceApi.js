...
* @module api/PayorServiceApi
* @version 2.10.61
*/
export default class PayorServiceApi {

    /**
    * Constructs a new PayorServiceApi. 
    * @alias module:api/PayorServiceApi
    * @class
    ...
    */
     ...
     * @callback module:api/PayorServiceApi~payorEmailOptOutCallback
     ...
     * @param {module:model/PayorEmailOptOutRequest} payorEmailOptOutRequest Details of application API key to create
     * @param {module:api/PayorServiceApi~payorEmailOptOutCallback} callback The callback function, accepting three arguments: error, data, response
     */
