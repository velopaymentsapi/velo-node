...
export default class UsersApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the emailUpdate operation.
     * @callback module:api/UsersApi~emailUpdateCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} userId The UUID of the User.
     * @param {module:model/EmailUpdateRequest} emailUpdateRequest a new email address
     * @param {module:api/UsersApi~emailUpdateCallback} callback The callback function, accepting three arguments: error, data, response
     */
    emailUpdate(userId, emailUpdateRequest, callback) {
      let postBody = emailUpdateRequest;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling emailUpdate");
      }
      // verify the required parameter 'emailUpdateRequest' is set
      if (emailUpdateRequest === undefined || emailUpdateRequest === null) {
        throw new Error("Missing the required parameter 'emailUpdateRequest' when calling emailUpdate");
      }
      ...
      let returnType = null;
      return this.apiClient.callApi(
        '/v2/users/{userId}/emailUpdate', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/UserResponse2} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/UserResponse2}
     */
    getSelf(callback) {
      let postBody = null;
     ...
     */
    unregisterMFAForSelf(selfMFATypeUnregisterRequest, callback) {
