...
export default class PayorInformationApi {
    ...
    */
     ...
     * @callback module:api/PayorInformationApi~getSourceAccountsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PayorInformationApi~getSourceAccountsCallback} callback The callback function, accepting three arguments: error, data, response
