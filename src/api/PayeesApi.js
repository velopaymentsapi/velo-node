...
export default class PayeesApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/PayeeResponseV3} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/PayeeResponseV3}
     */
    getPayeeByIdV3(payeeId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PayeeResponseV3;
      return this.apiClient.callApi(
