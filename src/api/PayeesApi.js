...
export default class PayeesApi {
    ...
    */
     ...
     */
    deletePayeeByIdV1(payeeId, callback) {
      let postBody = null;
     ...
     */
    getPayeeByIdV1(payeeId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
     ...
     */
    getPayeeByIdV2(payeeId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PayeeResponseV2;
      return this.apiClient.callApi(
    ...
    getPayeeByIdV3(payeeId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PayeeDetailResponse;
      return this.apiClient.callApi(
    ...
    getPayeeByIdV4(payeeId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PayeeDetailResponse2;
      return this.apiClient.callApi(
    ...
    listPayeeChangesV3(payorId, updatedSince, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PayeeDeltaResponse2;
      return this.apiClient.callApi(
     ...
     */
    listPayeesV1(payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
     ...
     */
    payeeDetailsUpdateV3(payeeId, updatePayeeDetailsRequest, callback) {
      let postBody = updatePayeeDetailsRequest;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
     ...
     */
    payeeDetailsUpdateV4(payeeId, updatePayeeDetailsRequest2, callback) {
      let postBody = updatePayeeDetailsRequest2;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
     ...
     */
    v3PayeesPayeeIdRemoteIdUpdatePost(payeeId, updateRemoteIdRequest, callback) {
      let postBody = updateRemoteIdRequest;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
     ...
     */
    v4PayeesPayeeIdRemoteIdUpdatePost(payeeId, updateRemoteIdRequest, callback) {
      let postBody = updateRemoteIdRequest;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
