...
export default class WithdrawPayoutApi {
    ...
    */
     ...
     * @callback module:api/WithdrawPayoutApi~withdrawPayoutV3Callback
     ...
     * @param {module:api/WithdrawPayoutApi~withdrawPayoutV3Callback} callback The callback function, accepting three arguments: error, data, response
     */
