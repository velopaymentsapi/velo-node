...
export default class PayoutHistoryApi {
    ...
    */
     ...
     * @callback module:api/PayoutHistoryApi~getPayoutStatsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PayoutHistoryApi~getPayoutStatsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetPayoutStatistics}
     */
    getPayoutStats(opts, callback) {
      opts = opts || {};
      let postBody = null;
