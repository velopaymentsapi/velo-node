...
* @module api/PayeeServiceApi
* @version 2.10.61
*/
export default class PayeeServiceApi {

    /**
    * Constructs a new PayeeServiceApi. 
    * @alias module:api/PayeeServiceApi
    * @class
    ...
    */
     ...
     * @callback module:api/PayeeServiceApi~deletePayeeByIdCallback
     ...
     * @param {module:api/PayeeServiceApi~deletePayeeByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
