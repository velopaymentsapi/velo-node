...
export default class PaymentAuditServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the exportTransactionsCSV operation.
     * @callback module:api/PaymentAuditServiceApi~exportTransactionsCSVCallback
     ...
     * @param {Date} opts.submittedDateFrom Start date, inclusive. Format is YYYY-MM-DD
     * @param {module:api/PaymentAuditServiceApi~exportTransactionsCSVCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link String}
     */
    exportTransactionsCSV(payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling exportTransactionsCSV");
      }
    ...
    /**
     * Callback function to receive the result of the getFundings operation.
     * @callback module:api/PaymentAuditServiceApi~getFundingsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} payorId The account owner Payor ID
     * @param {Object} opts Optional parameters
     * @param {Number} opts.pageNumber Page number. Default is 1. (default to 1)
     ...
     * @param {module:api/PaymentAuditServiceApi~getFundingsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetFundingsResponse}
     */
    getFundings(payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling getFundings");
      }
     ...
     */
    getPaymentDetails(paymentId, opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetPaymentsForPayoutResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/GetPaymentsForPayoutResponse}
     */
    getPaymentsForPayout(payoutId, opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetPaymentsForPayoutResponse;
      return this.apiClient.callApi(
    ...
    /**
     * Callback function to receive the result of the getPayoutStats operation.
     * @callback module:api/PaymentAuditServiceApi~getPayoutStatsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} payorId The account owner Payor ID
     * @param {module:api/PaymentAuditServiceApi~getPayoutStatsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetPayoutStatistics}
     */
    getPayoutStats(payorId, callback) {
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling getPayoutStats");
      }
    ...
    /**
     * Callback function to receive the result of the getPayoutsForPayor operation.
     * @callback module:api/PaymentAuditServiceApi~getPayoutsForPayorCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PaymentAuditServiceApi~getPayoutsForPayorCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetPayoutsResponse}
     */
    getPayoutsForPayor(payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling getPayoutsForPayor");
      }
     ...
     * @param {Number} opts.paymentAmountFrom The payment amount from range filter. Filters for paymentAmount &gt;&#x3D; paymentAmountFrom
     * @param {Number} opts.paymentAmountTo The payment amount to range filter. Filters for paymentAmount ⇐ paymentAmountTo
     * @param {String} opts.paymentCurrency The source currency filter. Filters based on an exact match on the currency.
     * @param {Date} opts.submittedDateFrom The submitted date from range filter. Format is yyyy-MM-dd.
     * @param {Date} opts.submittedDateTo The submitted date to range filter. Format is yyyy-MM-dd.
     ...
     */
    listPaymentsAudit(payeeId, payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payeeId' is set
      if (payeeId === undefined || payeeId === null) {
        throw new Error("Missing the required parameter 'payeeId' when calling listPaymentsAudit");
      }
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling listPaymentsAudit");
      }
