...
export default class PaymentAuditServiceApi {
    ...
    */
     ...
     */
    getPayoutsForPayorV4(payorId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'payorId' is set
      if (payorId === undefined || payorId === null) {
        throw new Error("Missing the required parameter 'payorId' when calling getPayoutsForPayorV4");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetPayoutsResponseV4;
      return this.apiClient.callApi(
