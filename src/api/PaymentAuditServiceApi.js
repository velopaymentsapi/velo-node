...
export default class PaymentAuditServiceApi {
    ...
    */
    ...
    exportTransactionsCSVV4(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/csv'];
      let returnType = PayorAmlTransactionV4;
      return this.apiClient.callApi(
     ...
     * @param {Number} opts.page Page number. Default is 1. (default to 1)
     * @param {Number} opts.pageSize Page size. Default is 25. Max allowable is 100. (default to 25)
     * @param {String} opts.sort List of sort fields (e.g. ?sort=submittedDateTime:asc,instructedDateTime:asc,status:asc) Default is submittedDateTime:asc The supported sort fields are: submittedDateTime, instructedDateTime, status, totalPayments 
