...
/**
* PayorBranding service.
* @module api/PayorBrandingApi
* @version 2.10.61
*/
export default class PayorBrandingApi {

    /**
    * Constructs a new PayorBrandingApi. 
    * @alias module:api/PayorBrandingApi
    * @class
    ...
    */
     ...
     * @callback module:api/PayorBrandingApi~payorAddPayorLogoCallback
     ...
     * @param {module:api/PayorBrandingApi~payorAddPayorLogoCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/PayorBrandingApi~payorGetBrandingCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} payorId The account owner Payor ID
     * @param {module:api/PayorBrandingApi~payorGetBrandingCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    payorGetBranding(payorId, callback) {
      ...
      return this.apiClient.callApi(
        '/v1/payors/{payorId}/branding', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
