...
var PayeeInvitationApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(PayeeInvitationApi, [{
    key: "getPayeesInvitationStatusV1",
    value: function getPayeesInvitationStatusV1(payorId, callback) {
      ...
      var returnType = _InvitationStatusResponse["default"];
      return this.apiClient.callApi('/v1/payees/payors/{payorId}/invitationStatus', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "getPayeesInvitationStatusV2",
    value: function getPayeesInvitationStatusV2(payorId, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'payorId' is set
      ...
      return this.apiClient.callApi('/v2/payees/payors/{payorId}/invitationStatus', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "queryBatchStatusV2",
    value: function queryBatchStatusV2(batchId, callback) {
      ...
      return this.apiClient.callApi('/v2/payees/batch/{batchId}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    key: "resendPayeeInviteV1",
    value: function resendPayeeInviteV1(payeeId, invitePayeeRequest, callback) {
      ...
      var accepts = ['application/json'];
      var returnType = null;
      return this.apiClient.callApi('/v1/payees/{payeeId}/invite', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
    ...
    value: function resendPayeeInviteV3(payeeId, invitePayeeRequest2, callback) {
    ...
    key: "v2CreatePayee",
    value: function v2CreatePayee(opts, callback) {
      opts = opts || {};
      ...
      return this.apiClient.callApi('/v2/payees', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
