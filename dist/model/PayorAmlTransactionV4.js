...
/**
 * The PayorAmlTransactionV4 model module.
 * @module model/PayorAmlTransactionV4
 * @version 2.23.78
 */
var PayorAmlTransactionV4 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PayorAmlTransactionV4</code>.
   * @alias module:model/PayorAmlTransactionV4
   */
  function PayorAmlTransactionV4() {
    _classCallCheck(this, PayorAmlTransactionV4);

    PayorAmlTransactionV4.initialize(this);
  }
  /**
  ...
  _createClass(PayorAmlTransactionV4, null, [{
    key: "initialize",
    value: function initialize(obj) {}
    /**
     * Constructs a <code>PayorAmlTransactionV4</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayorAmlTransactionV4} obj Optional instance to populate.
     * @return {module:model/PayorAmlTransactionV4} The populated <code>PayorAmlTransactionV4</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PayorAmlTransactionV4();
...
PayorAmlTransactionV4.prototype['transactionDate'] = undefined;
/**
 * @member {String} transactionTime
 */

PayorAmlTransactionV4.prototype['transactionTime'] = undefined;
/**
 * @member {String} reportTransactionType
 */

PayorAmlTransactionV4.prototype['reportTransactionType'] = undefined;
/**
 * @member {Number} debit
 */

PayorAmlTransactionV4.prototype['debit'] = undefined;
/**
 * ISO 4217 3 character currency code
 * @member {String} debitCurrency
 */

PayorAmlTransactionV4.prototype['debitCurrency'] = undefined;
/**
 * @member {Number} credit
 */

PayorAmlTransactionV4.prototype['credit'] = undefined;
/**
 * ISO 4217 3 character currency code
 * @member {String} creditCurrency
 */

PayorAmlTransactionV4.prototype['creditCurrency'] = undefined;
/**
 * @member {String} returnFee
 */

PayorAmlTransactionV4.prototype['returnFee'] = undefined;
/**
 * ISO 4217 3 character currency code
 * @member {String} returnFeeCurrency
 */

PayorAmlTransactionV4.prototype['returnFeeCurrency'] = undefined;
/**
 * @member {String} returnFeeDescription
 */

PayorAmlTransactionV4.prototype['returnFeeDescription'] = undefined;
/**
 * @member {String} returnCode
 */

PayorAmlTransactionV4.prototype['returnCode'] = undefined;
/**
 * @member {String} returnDescription
 */

PayorAmlTransactionV4.prototype['returnDescription'] = undefined;
/**
 * @member {String} fundingType
 */

PayorAmlTransactionV4.prototype['fundingType'] = undefined;
/**
 * @member {String} dateFundingRequested
 */

PayorAmlTransactionV4.prototype['dateFundingRequested'] = undefined;
/**
 * @member {String} payeeName
 */

PayorAmlTransactionV4.prototype['payeeName'] = undefined;
/**
 * Remote ID of the Payee, set by Payor
 * @member {String} remoteId
 */

PayorAmlTransactionV4.prototype['remoteId'] = undefined;
/**
 * @member {String} payeeType
 */

PayorAmlTransactionV4.prototype['payeeType'] = undefined;
/**
 * @member {String} payeeEmail
 */

PayorAmlTransactionV4.prototype['payeeEmail'] = undefined;
/**
 * @member {String} sourceAccount
 */

PayorAmlTransactionV4.prototype['sourceAccount'] = undefined;
/**
 * @member {Number} paymentAmount
 */

PayorAmlTransactionV4.prototype['paymentAmount'] = undefined;
/**
 * ISO 4217 3 character currency code
 * @member {String} paymentCurrency
 */

PayorAmlTransactionV4.prototype['paymentCurrency'] = undefined;
/**
 * @member {String} paymentMemo
 */

PayorAmlTransactionV4.prototype['paymentMemo'] = undefined;
/**
 * @member {String} paymentType
 */

PayorAmlTransactionV4.prototype['paymentType'] = undefined;
/**
 * @member {String} paymentRails
 */

PayorAmlTransactionV4.prototype['paymentRails'] = undefined;
/**
 * @member {String} payorPaymentId
 */

PayorAmlTransactionV4.prototype['payorPaymentId'] = undefined;
/**
 * @member {String} paymentStatus
 */

PayorAmlTransactionV4.prototype['paymentStatus'] = undefined;
/**
 * @member {String} rejectReason
 */

PayorAmlTransactionV4.prototype['rejectReason'] = undefined;
/**
 * @member {Number} fxApplied
 */

PayorAmlTransactionV4.prototype['fxApplied'] = undefined;
var _default = PayorAmlTransactionV4;
