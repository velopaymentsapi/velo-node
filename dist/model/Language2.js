...
* @readonly
*/
var Language2 = /*#__PURE__*/function () {
  function Language2() {
    _classCallCheck(this, Language2);
  ...
  _createClass(Language2, null, [{
    key: "constructFromObject",

    /**
    * Returns a <code>Language2</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/Language2} The enum <code>Language2</code> value.
    */
