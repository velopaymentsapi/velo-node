...
var _InlineResponse412Errors = _interopRequireDefault(require("./InlineResponse412Errors"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errors')) {
          obj['errors'] = _ApiClient["default"].convertToType(data['errors'], [_InlineResponse412Errors["default"]]);
        }
