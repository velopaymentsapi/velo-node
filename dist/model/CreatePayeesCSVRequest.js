 ...
 * @version 2.29.130
 */
var CreatePayeesCSVRequest = /*#__PURE__*/function () {
  /**
   ...
   * @param addressCountry {module:model/CreatePayeesCSVRequest.AddressCountryEnum} Must be a 2 character country code - per ISO 3166-1
   */
  function CreatePayeesCSVRequest(type, remoteId, email, addressLine1, addressCity, addressZipOrPostcode, addressCountry) {
    _classCallCheck(this, CreatePayeesCSVRequest);
  ...
  _createClass(CreatePayeesCSVRequest, null, [{
    key: "initialize",
 ...
 * @member {module:model/CreatePayeesCSVRequest.AddressCountryEnum} addressCountry
 */
...
CreatePayeesCSVRequest['AddressCountryEnum'] = {
  /**
   * value: "AF"
   * @const
   */
...
var _default = CreatePayeesCSVRequest;
