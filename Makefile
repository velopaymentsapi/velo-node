help:
	@echo ""
	@echo "\033[0;34m    Velo Payments - Node Client (\033[1;34mvelo-node\033[0;34m) \033[0m"
	@echo ""
...
info:
	sed -i.bak 's/"name": "velo_payments_ap_is"/"name": "velo-node"/' package.json && rm package.json.bak
